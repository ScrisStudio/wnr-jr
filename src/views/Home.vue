  ...
  <div class="home">
    <div class="justify-content-start align-content-center" id="home-input">
      ...
      <input
        ...
        class="work work-rest-input s-input s-input-number s-input-border-bottom w-250"
        autofocus
        required
    ...
    <div id="only-rest-modal">
      <div id="controller-center" class="rest">{{ $t("home.onlyRest") }}</div>
...
const { Storage, NotificationManagerSpecified } = Plugins;
export default {
  data: function() {
    return {
      title: "",
